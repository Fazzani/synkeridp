...
using SynkerIdpAdminUI.STS.Identity.Models.Consent;
using SynkerIdpAdminUI.STS.Identity.Models.Device;

namespace SynkerIdpAdminUI.STS.Identity.Controllers.Device
{
    [Authorize]
    [SecurityHeaders]
